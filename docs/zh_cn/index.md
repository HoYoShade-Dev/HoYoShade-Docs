...
hero:
  ...
  tagline: 首发搭载 ⌈幻港之蝶⌋ 注入内核。哈游宇宙，One Core就够！
  image:
...
features:
  ...
  - title: 🚀更通用，更易用，多联动
    details: 全新开发可靠，可量化，自适应注入器 ⌈幻港之蝶⌋，无需配置任何文件，只需启动游戏，即可完成既往所有繁琐步骤，降低学习成本。同时，这也为我们带来了链式启动的可能，无论使用何种Mod，你总能找到可以联动HoYoShade启动的方式。
  - title: ⛓️‍💥可离线，抗封锁，抗审查
